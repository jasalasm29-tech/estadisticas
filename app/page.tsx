    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 py-24 text-center sm:px-6 lg:px-8 lg:py-32">
          <span className="glass inline-block px-4 py-1.5 text-sm font-medium text-cyan">
      ...
      <section id="features" className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((f) => (
            <div
              key={f.title}
              className="glass p-6 transition-all duration-200 hover:-translate-y-1 hover:border-cyan/40"
            >
      ...
      <section id="pricing" className="mx-auto max-w-5xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl font-bold sm:text-4xl">Planes simples</h2>
          <p className="mx-auto mt-4 max-w-2xl text-gray-400">
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2">
          ...
          <div className="glass flex flex-col p-8">
            <h3 className="text-xl font-semibold text-white">Plan Gratuito</h3>
            <p className="mt-2 text-sm text-gray-400">Para empezar a explorar.</p>
            <p className="mt-6">
          ...
          {/* Plan Premium */}
          <div className="glass relative flex flex-col border-cyan/40 p-8 shadow-2xl shadow-magenta/10">
            ...
            <p className="mt-2 text-sm text-gray-400">Para apostadores serios.</p>
            <p className="mt-6">
              <span className="text-4xl font-extrabold text-white">$6.990</span>
              <span className="text-gray-400"> CLP / mes</span>
            </p>
            <ul className="mt-6 flex-1 space-y-3">
